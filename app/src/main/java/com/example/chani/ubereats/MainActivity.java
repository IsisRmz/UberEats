...
public class MainActivity extends AppCompatActivity {
    ...
    class iniciarRest extends AsyncTask<String, Integer, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                connection = new URL("http://192.168.1.74/cursoAndroid/vista/usuario/iniciarSesion.php?usuario="+strings[0]+"&password="+strings[1]).openConnection();
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.equals("1")){
                //Lanzamos la nueva actividad si el logueo fue exitoso
